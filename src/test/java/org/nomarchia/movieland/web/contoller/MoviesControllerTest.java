...
//        //prepare
//        when(movieService.findAll(new SortedMoviesRequest())).thenReturn(expectedMovies);
//
//        //when
...
//        //prepare
//        when(movieService.findByGenre(eq(1L), new SortedMoviesRequest())).thenReturn(expectedMovies);
//
//        //when
